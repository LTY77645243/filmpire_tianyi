...
import { Movie as MovieIcon, Theaters, Language, PlusOne, Remove, ArrowBack, Thermostat } from '@mui/icons-material';
            ...
            <Grid item container direction='column' lg={7}>
                ...
                <Grid item container style={{ marginTop: '2rem' }}>
                    <div className={ classes.buttonsContainer }>
                        ...
                        <Grid item xs={12} sm={6} className={ classes.buttonsContainer }>
                            <ButtonGroup variant='outlined' size='meidum'>
                                <Button onClick={addToFavorites} endIcon={isMovieFavorited ? <FavoriteBorderIcon /> : <FavoriteIcon />}>
